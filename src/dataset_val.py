"""
Validation dataset for the Face Blurring project.

Applies deterministic Albumentations transforms (resize, pad, normalize) and updates
...
class HumanCatDogClass_val(Dataset):
    """
    Dataset for validation/evaluation with Albumentations.
    ...
    def __init__(self, csv_address, folder_path, transform=None):
        ...
        # Default transform if none is provided (should normally be passed from main.py)
